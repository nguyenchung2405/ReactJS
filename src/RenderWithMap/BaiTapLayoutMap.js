        ...
        return this.dataPhim.map((Film, index) => {
            return <div key={index} className="col-4 mt-5">
                <div className="card text-left">
                    <div style={{ background: `url('${Film.hinhAnh}') no-repeat` }}>
                        <img style={{ opacity: 0 }} className="card-img-top" src={Film.hinhAnh} height="300px" alt="hình ảnh" />
                    </div>

                    <div className="card-body">
                        <h4 style={{ height: '50px' }} className="card-title">{Film.tenPhim}</h4>
    ...
    render() {
        return (
            <div className="container">
                <h2 className="text-dark text-center mt-4">Danh sách phim</h2>
                <div className="row">
                    {this.renderFilmList()}
                </div>
            </div>
